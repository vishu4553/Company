...
public class Promotion extends BaseActivity {
    ...
    private void initializeView() {
        ...
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    if (MyApplication.getInstance().isConnectedToNetwork(Promotion.this)) {
                        validation();
                        //finish();
                    } else {
                        showMyDiag();
    ...
    private void registerUser() {
        ...
        try {
            requestJson = new JSONObject();
           /* requestJson.put("email", "c@gmail.com");
            requestJson.put("password", "pass123");
            requestJson.put("lat", "3");
            requestJson.put("longg", "3");
            requestJson.put("name", "c");
            requestJson.put("contact_no", "88552244225");
            requestJson.put("address", "wardha road");
            requestJson.put("city", "ngp");
            requestJson.put("website", "cyber.com");
            ...
            requestJson.put("cmpy_img", "cyber.img");
            requestJson.put("player_id", MyApplication.getInstance().getFromSharedPreference(PLAYER_ID));
                ...
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        try {
                            ...
                            status.startResolutionForResult(Promotion.this, REQUEST_LOCATION);
